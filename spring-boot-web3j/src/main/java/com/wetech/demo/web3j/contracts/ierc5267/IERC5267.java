package com.wetech.demo.web3j.contracts.ierc5267;
...
public class IERC5267 extends Contract {
    ...
    @Deprecated
    protected IERC5267(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected IERC5267(String contractAddress, Web3j web3j, TransactionManager transactionManager,
            BigInteger gasPrice, BigInteger gasLimit) {
    ...
    @Deprecated
    public static IERC5267 load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new IERC5267(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static IERC5267 load(String contractAddress, Web3j web3j,
    ...
    public static RemoteCall<IERC5267> deploy(Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
    ...
    public static RemoteCall<IERC5267> deploy(Web3j web3j, TransactionManager transactionManager,
            ContractGasProvider contractGasProvider) {
