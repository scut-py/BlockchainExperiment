package com.wetech.demo.web3j.contracts.erc20permit;
...
public class ERC20Permit extends Contract {
    ...
    @Deprecated
    protected ERC20Permit(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected ERC20Permit(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static ERC20Permit load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new ERC20Permit(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static ERC20Permit load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public static RemoteCall<ERC20Permit> deploy(Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
    ...
    public static RemoteCall<ERC20Permit> deploy(Web3j web3j, TransactionManager transactionManager,
            ContractGasProvider contractGasProvider) {
