package com.wetech.demo.web3j.contracts.eip712;
...
public class EIP712 extends Contract {
    ...
    @Deprecated
    protected EIP712(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected EIP712(String contractAddress, Web3j web3j, TransactionManager transactionManager,
            BigInteger gasPrice, BigInteger gasLimit) {
    ...
    @Deprecated
    public static EIP712 load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new EIP712(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static EIP712 load(String contractAddress, Web3j web3j,
    ...
    public static RemoteCall<EIP712> deploy(Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
    ...
    public static RemoteCall<EIP712> deploy(Web3j web3j, TransactionManager transactionManager,
            ContractGasProvider contractGasProvider) {
